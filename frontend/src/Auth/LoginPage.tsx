...
const strengthLabel = (n: number) =>
  ["", "Very Weak", "Weak", "Fair", "Strong", "Very Strong"][n] ?? "Very Strong";
...
const Err = ({ msg }: { msg: string }) => (
  <p style={{ fontSize: 11.5, color: "#ef4444", fontWeight: 600, margin: "4px 0 0", ...fw }}>
    {msg}
  </p>
);
...
const PBtn = ({
  ...
  <button
    ...
    onClick={onClick}
    className={`w-full flex items-center justify-center gap-2 py-[18px] h-[40px] px-5 rounded-[30px] border-none text-sm font-bold text-white transition-all duration-150 ${
      loading || disabled
  ...
  return (
    ...
    >
        ...
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            ...
            style={{
              ...
              height: 4,
              borderRadius: 3,
              background: i <= s ? strengthColor(s) : "#cbd5e1",
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 10 }}>
        ...
        <span style={{ fontSize: 12, fontWeight: 800, color: strengthColor(s), ...fw }}>
          {strengthLabel(s)}
        </span>
      </div>
...
const LeftPanel = () => (
  ...
  >
    ...
    >
      ...
      <span
        style={{ fontSize: 19, fontWeight: 800, color: "white", letterSpacing: "-0.2px", ...fw }}
      >
        VanLoka
      </span>
    </div>
...
const MobileNavbar = () => (
  ...
  >
    <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
      ...
      <span
        style={{ fontSize: 16, fontWeight: 800, color: "#0f172a", letterSpacing: "-0.3px", ...fw }}
      >
        VanLoka
      </span>
    </div>
  ...
  return (
    <>
      <div style={{ textAlign: "center", marginBottom: 20 }}>
        ...
        <p style={{ fontSize: 12.5, color: "#94a3b8", fontWeight: 500, margin: 0, ...fw }}>
      ...
      >
        {errs.general && (
          ...
          >
            ...
            <span style={{ fontSize: 12.5, color: "#991b1b", fontWeight: 700, ...fw }}>
              {errs.general}
            </span>
          </div>
        )}
        ...
        <label style={{ display: "flex", alignItems: "center", gap: 8, cursor: "pointer" }}>
          ...
          <span
            style={{ fontSize: 13, fontWeight: 500, color: "#475569", userSelect: "none", ...fw }}
          >
  ...
  return (
    <>
      ...
      <div style={{ textAlign: "center", marginBottom: 22 }}>
        ...
        >
          Enter your email — we'll send a 6-digit secure login code.
        </p>
      </div>
      <form
        onSubmit={submit}
...
const OtpFormScreen = ({
  ...
  const submit = async (ev: FormEvent) => {
    ...
    if (code !== "123456") {
      setErr("Invalid code. (Demo: use 123456)");
      return;
    }
    setLoading(true);
          ...
          {otp.map((d, i) => (
            <input
              ...
              style={{
                ...
                outline: "none",
                ...fw,
                border: `2px solid ${err ? "#f87171" : d ? "#7C3AED" : "#e2e8f0"}`,
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 5, marginTop: 4 }}>
              <div
                style={{
                  ...
                  height: 7,
                  borderRadius: "50%",
                  background: form.newPassword === form.confirmPassword ? "#22c55e" : "#ef4444",
                }}
              />
              <span
                style={{
            ...
            <div style={{ width: "100%", maxWidth: 420, margin: "auto", flexShrink: 0 }}>
              ...
              <div
                style={{
                  ...
                  boxShadow: "0 4px 28px rgba(124,58,237,0.07), 0 1px 4px rgba(0,0,0,0.04)",
              ...
              >
                {screen === "login" && (
                  <LoginFormScreen
                    ...
                    onOtpLogin={() => setScreen("otp_login_request")}
                  />
                )}
                {screen === "otp_login_request" && (
                  <OtpLoginRequestScreen
                    onBack={() => setScreen("login")}
                    onSent={(e) => {
                      setResetEmail(e);
                      setScreen("otp_login_verify");
                    }}
                  />
                )}
                {screen === "otp_login_verify" && (
                  <OtpFormScreen
                    email={resetEmail}
                    onBack={() => setScreen("otp_login_request")}
                    onVerified={() => {}}
                    isLogin={true}
                  />
                )}
