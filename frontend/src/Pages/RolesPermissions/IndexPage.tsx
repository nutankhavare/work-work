...
import { type Role, getAvatarColor } from "../../data/rolesData";
      ...
      >
        ...
        <div className="bg-gradient-to-br from-[#7C3AED] to-[#4F46E5] p-8 flex items-center gap-6 rounded-t-2xl">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-3">
              <span className="text-[12px] text-white/75 font-[600]">ID: #{role.id}</span>
              <span
                className={`px-2 py-0.5 rounded-full text-[10px] font-[800] uppercase tracking-wider border shadow-xs ${
                  role.status === "Active"
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div>
              <p className="text-[10px] font-[800] text-[#94a3b8] uppercase tracking-wider mb-1">
                Department
              </p>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[14px] font-[700] text-[#1e293b]">
          ...
          {/* Description */}
          <div className="mb-8">
            <p className="text-[10px] font-[800] text-[#94a3b8] uppercase tracking-wider mb-2">
              Role Description
            </p>
          ...
          {/* Permissions */}
          <div>
            <p className="text-[10px] font-[800] text-[#94a3b8] uppercase tracking-wider mb-3">
...
export const IndexPage = () => {
  ...
  const fetchRoles = useCallback(async () => {
    ...
    try {
      ...
      setStats({
        ...
        admin: mappedRoles.filter(
          (r: any) => r.accessLevel === "Root Access" || r.accessLevel === "Full Access",
        ).length,
        custom: mappedRoles.filter(
          (r: any) => r.accessLevel === "Partial Access" || r.accessLevel === "Read Only",
        ).length,
      });
    } catch (error) {
  ...
  return (
    <div className="min-h-screen font-[var(--font-manrope)]">
                      ...
                      return (
                        ...
                        >
                          <Td className="py-5 pl-8">
                            <div className="flex items-center gap-4">
                              <div
                                className="w-10 h-10 rounded-[10px] flex items-center justify-center font-[900] text-[14px]"
                                style={{ background: av.bg, color: av.cl }}
                              >
                                {init}
                              </div>
                              <div>
                                <p className="text-[13.5px] font-[900] text-[#1e293b] leading-tight mb-1 uppercase">
                                  {r.roleName}
                                </p>
                                <p className="text-[11px] font-[700] text-[#94a3b8] uppercase tracking-wide">
                                  {r.department} • {r.accessLevel}
                                </p>
                              </div>
                            </div>
                          </Td>
                          <Td className="py-5">
                            <div className="flex flex-wrap gap-1.5 max-w-[300px]">
                              {r.permissions.slice(0, 2).map((p) => (
                                <span
                                  key={p}
                                  className="px-2 py-0.5 bg-[#f1f5f9] text-[#64748b] text-[10px] font-[800] rounded-md border border-[#e2e8f0] uppercase"
                                >
                                  {p}
                                </span>
                              ))}
      ...
      <AnimatePresence>
        {viewRole && (
          <ViewOverlay role={viewRole.r} index={viewRole.idx} onClose={() => setViewRole(null)} />
        )}
        {deleteRole && (
          <div
            className="fixed inset-0 z-[1000] bg-black/45 backdrop-blur-[2px] flex items-center justify-center p-6"
          ...
          >
            ...
            >
              ...
              <p className="text-[13px] text-[#64748b] mb-6 leading-relaxed">
                ...
                <span className="font-[800] text-[#1e293b]">{deleteRole.roleName}</span>. This
                action cannot be undone.
              </p>
              <div className="flex gap-3">
                <button
                  onClick={() => setDeleteRole(null)}
                  className="flex-1 px-5 py-3 bg-[#f1f5f9] text-[#64748b] rounded-xl font-[800] text-[13px] hover:bg-[#e2e8f0] transition-all uppercase"
                >
                  Cancel
                </button>
                <button
                  onClick={handleDelete}
                  className="flex-1 px-5 py-3 bg-[#dc2626] text-white rounded-xl font-[800] text-[13px] hover:bg-[#b91c1c] transition-all shadow-lg shadow-red-100 uppercase"
                >
                  Delete
                </button>
              </div>
