...
const Field = ({ label, value }: { label: string; value?: string | number | null }) => (
  <div className="py-3 border-b border-[#f8fafc] last:border-0 grow">
    ...
    <p className="text-[13px] font-[800] text-[#1e293b]">
...
const VehicleShowPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<"specs" | "telemetry" | "compliance" | "hardware">(
    "specs",
  );
    ...
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-[#fafbff] p-8">
        <EmptyState
          ...
          description="The asset records for this unit are either missing or decommissioned."
        />
        <button
          onClick={() => navigate("/vehicles")}
          className="mt-4 text-[#7c3aed] font-[800] uppercase text-[11px] hover:underline"
        >
          Go Back
        </button>
      </div>
          ...
          <div className="h-28 bg-[#1e293b] relative overflow-hidden">
            ...
            <div className="absolute top-6 left-8 flex items-center gap-3">
              ...
              <div>
                ...
                <h1 className="text-white text-xl font-black uppercase tracking-wider">
          ...
          <div className="px-8 pb-8 relative">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mt-6">
              <div className="flex-1">
                <h2 className="text-[20px] font-[900] text-[#1e293b] uppercase leading-tight">
                  {vehicle.vehicle_name || "Fleet Unit"}
                </h2>
                ...
                <div className="flex flex-wrap items-center gap-2 mt-4">
                  <span
                    className={`px-3 py-1.5 rounded-full text-[10.5px] font-[900] uppercase tracking-wider border shadow-sm ${vehicle.status?.toLowerCase() === "active" ? "bg-[#ecfdf5] text-[#059669] border-[#d1fae5]" : "bg-[#fffbeb] text-[#d97706] border-[#fef3c7]"}`}
                  >
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-right">
                ...
                <div>
                  ...
                  <p className="text-[16px] font-black text-[#1e293b]">
                    ...
                    <span className="text-[10px] text-[#94a3b8]">STR</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            {activeTab === "specs" && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <SectionCard
                  ...
                  colorClass="bg-[#f8faff] text-[#7c3aed]"
                >
                ...
                <SectionCard
                  ...
                  colorClass="bg-[#fcfdf2] text-[#d97706]"
                >
                  <Field label="Mfg Year" value={vehicle.manufacturing_year} />
                  <Field
                    label="RC Issue Date"
                    value={formatDateTime(vehicle.rc_isued_date || null)}
                  />
                ...
                <SectionCard
                  ...
                  colorClass="bg-[#fdf2f2] text-[#dc2626]"
                >
                  ...
                  <div className="mt-4 p-3 bg-white rounded-lg border border-[#f1f5f9]">
                    <p className="text-[10px] font-black text-[#94a3b8] uppercase mb-1">
                      Assigned Route
                    </p>
                    <p className="text-[13px] font-black text-[#1e293b]">
                      {vehicle.route || "Global Roaming"}
                    </p>
                  </div>
                </SectionCard>
                ...
                <SectionCard
                  icon={Users}
                  title="Driver Intel"
                  colorClass="bg-[#f0f9ff] text-[#3b82f6]"
                >
                  {vehicle.driver_first_name || vehicle.assigned_driver_id ? (
                    <>
                      <Field
                        label="Driver Name"
                        value={`${vehicle.driver_first_name || "Unknown"} ${vehicle.driver_last_name || ""}`}
                      />
                      <Field
                        label="Employee ID"
                        value={vehicle.driver_employee_id || vehicle.assigned_driver_id}
                      />
            ...
            {activeTab === "telemetry" && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <SectionCard
                  ...
                  colorClass="bg-[#f8fafc] text-[#0ea5e9]"
                >
                  <div className="grid grid-cols-2 gap-6">
                    <div className="p-4 bg-white rounded-[15px] border border-[#f1f5f9] shadow-sm">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-[10px] font-black text-[#94a3b8] uppercase pb-1">
                          Battery
                        </span>
                        <Battery
                          size={14}
                          className={
                            Number(vehicle.battery || 0) > 20 ? "text-[#059669]" : "text-[#dc2626]"
                          }
                        />
                      </div>
                    ...
                    <div className="p-4 bg-white rounded-[15px] border border-[#f1f5f9] shadow-sm">
                      ...
                      <p className="text-[24px] font-black text-[#1e293b]">
                        {vehicle.speed || 0}{" "}
                        <span className="text-[12px] text-[#94a3b8]">KM/H</span>
                      </p>
                    </div>
                  </div>
                </SectionCard>
                ...
                <SectionCard
                  ...
                  colorClass="bg-[#f0fdf4] text-[#059669]"
                >
                  <div className="space-y-4">
                    ...
                    <button
                      onClick={() => navigate(`/vehicles/track/${vehicle.vehicle_number}`)}
                      className="w-full py-3 bg-white border border-[#e2e8f0] rounded-[10px] text-[11px] font-black text-[#1e293b] uppercase tracking-wider hover:bg-[#fafbff] active:scale-95 transition-all"
                    >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                  <div className="p-4 rounded-[15px] bg-[#f8fafc] border border-indigo-50 h-full">
                    <p className="text-[10px] font-black text-[#7c3aed] uppercase tracking-widest mb-4">
                      Assigned Tracker
                    </p>
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <Field
                        label="Sync Date"
                        value={formatDateTime(vehicle.lastGpsUpdate ?? null)}
                      />
                    </div>
                  </div>
                </SectionCard>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                >
                  <div className="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <Field
                      label="PUC Expiry"
                      value={formatDateTime(vehicle.pollution_expiry_date || null)}
                    />
                    <Field label="Fitness Registry" value={vehicle.fitness_certificate_number} />
                    <Field
                      label="Fitness Expiry"
                      value={formatDateTime(vehicle.fitness_expiry_date || null)}
                    />
                  </div>
                  <div className="p-4 rounded-xl bg-[#f0f9ff] border border-blue-50">
                    ...
                    <div className="flex gap-4">
                      <Field
                        label="Issued"
                        value={formatDateTime(vehicle.insurance_issued_date || null)}
                      />
                      <Field
                        label="Expires"
                        value={formatDateTime(vehicle.insurance_expiry_date || null)}
                      />
                    </div>
                  </div>
                </SectionCard>
                ...
                <SectionCard
                  icon={FileText}
                  title="Fleet Vault"
                  colorClass="bg-[#fcfdf2] text-[#ea580c]"
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      return (
                        <div
                          key={doc}
                          className={`p-4 rounded-xl border border-[#f1f5f9] flex items-center justify-between ${path ? "bg-white opacity-100" : "bg-[#fafbff] opacity-50"}`}
                        >
                          <div className="flex-1">
                            <p className="text-[9px] font-black text-[#94a3b8] uppercase mb-0.5">
                              {doc.split("_")[0]}
                            </p>
                            <p className="text-[12px] font-black text-[#1e293b] uppercase tracking-tighter">
                              {doc.replace(/_/g, " ")}
                            </p>
                          ...
                          {path ? (
                            <a
                              href={
                                path.startsWith("http") ? path : `${centralUrl}/storage/${path}`
                              }
                              target="_blank"
                              rel="noreferrer"
                            ...
                            <span className="p-2 text-[#cbd5e1]">
                              <ShieldCheck size={18} />
                            </span>
                          )}
                        </div>
