...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    const selectedVehicle: any = vehicles.find(
      (v: any) => v.vehicle_number === selectedVehicleNumber,
    );
      ...
      <div className="px-4 lg:px-6 pb-8 space-y-8">
        ...
        {(() => {
          const selectedVehicle: any = selectedVehicleNumber
            ...
            : null;
          const drivers =
            selectedVehicle?.beacons?.filter((b: any) => b.type.toLowerCase() === "driver") || [];
          const passengers =
            selectedVehicle?.beacons?.filter(
              (b: any) => b.type.toLowerCase() === "traveller" || b.type.toLowerCase() === "staff",
            ) || [];
          ...
          return (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
              {/* Map Container */}
              <div
                className={`bg-white rounded-[18px] border border-[#eef2f6] shadow-[0_2px_12px_rgba(30,41,59,0.03)] overflow-hidden relative min-h-[500px] h-[550px] transition-all duration-300 ${selectedVehicle ? "lg:col-span-2" : "lg:col-span-3"}`}
              >
                {loading ? (
                  <div className="absolute inset-0 bg-slate-50 flex items-center justify-center flex-col gap-4">
                    ...
                    <div className="text-center">
                      <h3 className="text-sm font-[900] text-[#1e293b] uppercase tracking-widest">
                        Live Fleet Map
                      </h3>
                      <p className="text-[10px] font-[800] text-[#94a3b8] uppercase mt-1">
                  ...
                  <div className="absolute inset-0 bg-[#fafcff] flex items-center justify-center flex-col gap-4 p-8">
                    ...
                    <div className="text-center max-w-sm">
                      <h3 className="text-[15px] font-[900] text-[#1e293b] uppercase tracking-wider mb-2">
                        Live Fleet Tracking
                      </h3>
                      <p className="text-[12px] font-[600] text-[#64748b] leading-relaxed">
                        Map visualization placeholder. The live fleet is tracking dynamically in
                        sandbox mode.
                      </p>
                    </div>
                  </div>
                ...
                <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-slate-100 shadow-xl z-10 hidden md:block">
                  <p className="text-[10px] font-[900] text-[#1e293b] uppercase mb-3">
                    Fleet Status
                  </p>
                  ...
                  <div className="bg-slate-50 p-5 border-b border-slate-200">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="text-[14px] font-[900] text-slate-800 uppercase leading-none">
                      ...
                      {drivers.length > 0 ? (
                        <div className="space-y-2">
                          {drivers.map((d: any) => (
                            <div
                              key={d.id}
                              className="flex items-center p-2.5 bg-slate-50 border border-slate-200 rounded-lg"
                            >
                            ...
                            {passengers.map((pax: any) => (
                              ...
                              >
                                ...
                                <div className="flex flex-col items-end gap-0.5">
                                  <span
                                    className="text-[8px] text-slate-400 flex items-center gap-1 bg-slate-50 px-1 py-0.5 rounded"
                                    title="Last Seen"
                                  >
