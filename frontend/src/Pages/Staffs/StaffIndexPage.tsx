    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#0f1028]/50 backdrop-blur-[4px]">
      ...
      >
        ...
        <div className="p-8">
          {!file ? (
            <label className="flex flex-col items-center justify-center border-2 border-dashed border-[#e2e8f0] bg-[#fafbff] py-12 px-6 rounded-[16px] cursor-pointer hover:border-[#7c3aed] transition-colors group">
              <CloudUpload
                size={48}
                className="text-[#cbd5e1] group-hover:text-[#7c3aed] mb-4 transition-colors"
              />
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 p-4 bg-[#f8fafc] border border-[#e2e8f0] rounded-[12px]">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[13px] font-[800] text-[#1e293b] truncate uppercase">
                    {file.name}
                  </p>
              ...
              {isParsing ? (
                ...
                <div className="bg-[#ecfdf5] border border-[#d1fae5] p-4 rounded-[12px]">
                  <p className="text-[13px] font-[800] text-[#065f46]">
                    Successfully parsed {preview.length} employees
                  </p>
                  <p className="text-[11px] font-[600] text-[#059669]">
        ...
        <div className="px-6 py-4 bg-[#f8fafc] border-t border-[#f1f5f9] flex gap-3 justify-end">
          <button
            onClick={onClose}
            className="px-5 py-2.5 text-[12.5px] font-[800] text-[#475569] hover:bg-[#e2e8f0] rounded-[10px] transition-colors"
          >
            Cancel
          </button>
          <button
            ...
            className="px-6 py-2.5 bg-[#7c3aed] text-white text-[12.5px] font-[800] rounded-[10px] disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_4px_14px_rgba(124,58,237,0.25)]"
          >
            Import Data
          </button>
        </div>
...
const StaffIndexPage = () => {
  ...
  const fetchStaff = useCallback(async () => {
    ...
    try {
      ...
      setStats({
        ...
        onLeave:
          employees.filter((s: any) =>
            ["leave", "on leave", "onleave"].includes(s.status?.toLowerCase() || ""),
          ).length || 0,
  ...
  const handleDelete = async (emp: Employee) => {
    if (!(await confirm(`Delete ${emp.first_name} ${emp.last_name}? This cannot be undone.`)))
      return;
    try {
  ...
  const buildBulkPdf = useCallback(
    (opts: any) => {
      ...
      doc.text(
        opts.subtitle || `Generated for ${new Date().toLocaleDateString()}`,
        opts.logo ? 45 : 14,
        26,
      );
      ...
      <img
        ...
        onError={(e) => {
          (e.target as HTMLImageElement).src =
            `https://ui-avatars.com/api/?name=${employee.first_name}+${employee.last_name}&background=ede9fe&color=7c3aed&bold=true&font-size=0.45`;
        }}
      />
    );
  };
                      ...
                      >
                        ...
                        <Td className="py-5">
                          <div className="flex flex-col">
                            <span className="text-[13px] font-[800] text-[#475569]">
                          ...
                          <span
                            className={`px-3 py-1.5 rounded-full text-[10.5px] font-[900] uppercase tracking-wider border shadow-xs ${
                              row.status?.toLowerCase() === "active"
                                ...
                                : ["leave", "on leave", "onleave"].includes(
                        ...
                        <Td className="py-5 text-center pr-8">
                          <div className="flex items-center justify-center gap-1.5">
                            ...
                            <button
                              ...
                              className="p-2 text-[#64748b] hover:text-[#059669] hover:bg-[#ebfef5] rounded-[8px] transition-all"
