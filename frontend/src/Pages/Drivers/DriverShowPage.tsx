...
const DriverShowPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<"details" | "professional" | "documents" | "beacon">(
    "details",
  );
    ...
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-[#fafbff] p-8">
        <EmptyState
          ...
          description="The fleet records for this ID are either missing or inaccessible."
        />
        <button
          onClick={() => navigate("/drivers")}
          className="mt-4 text-[#7c3aed] font-[800] uppercase text-[11px] hover:underline transition-all"
        >
          Go Back
        </button>
      </div>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-white text-[#475569] border border-[#e2e8f0] rounded-[10px] text-[12.5px] font-[800] hover:bg-[#f8fafc] transition-all"
            >
              <Download size={16} />
              Export Report
            </button>
          ...
          <div className="px-8 pb-8 relative">
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-6 -mt-14">
              <div className="relative">
                <img
                  src={
                    driver.profile_photo
                      ? driver.profile_photo.startsWith("http")
                        ? driver.profile_photo
                ...
                />
                <div
                  className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 border-white ${driver.status === "active" ? "bg-[#059669]" : "bg-[#94a3b8]"}`}
                />
              </div>

              <div className="flex-1">
                <h1 className="text-[22px] font-[900] text-[#1e293b]">
                  {driver.first_name} <span className="text-[#7c3aed]">{driver.last_name}</span>
                </h1>
                ...
                <div className="flex flex-wrap items-center gap-2 mt-4">
                  <span
                    className={`px-3 py-1.5 rounded-full text-[10.5px] font-[900] uppercase tracking-wider border shadow-sm ${driver.status?.toLowerCase() === "active" ? "bg-[#ecfdf5] text-[#059669] border-[#d1fae5]" : "bg-[#fef2f2] text-[#dc2626] border-[#fee2e2]"}`}
                  >
          ...
          <div className="border-t border-[#f1f5f9] px-4 sm:px-8 flex gap-1 overflow-x-auto custom-scrollbar">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-5 py-4 text-[11px] font-[800] uppercase tracking-wider transition-all relative border-b-[3px] whitespace-nowrap ${activeTab === tab.key ? "text-[#7c3aed] border-[#7c3aed]" : "text-[#94a3b8] border-transparent hover:text-[#475569]"}`}
              >
                <tab.icon size={15} />
                {tab.label}
              </button>
            ...
            {activeTab === "details" && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <SectionCard
                  ...
                  colorClass="bg-[#fafbff] text-[#dc2626]"
                >
                  <p className="text-[10px] font-[900] text-[#dc2626] uppercase opacity-60 mb-2 tracking-widest">
                    Primary Emergency
                  </p>
                  ...
                  <p className="text-[10px] font-[900] text-[#64748b] uppercase opacity-60 mb-2 tracking-widest">
                    Secondary Contact
                  </p>
                ...
                <SectionCard
                  icon={CreditCard}
                  title="Bank Registry"
                  colorClass="bg-[#fafbff] text-[#0ea5e9]"
                >
                  ...
                  >
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                      <div className="md:col-span-2">
                        <Field
                          label="Fleet Residence"
                          value={`${driver.address_line_1}, ${driver.address_line_2 || ""}`}
                        />
                      </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <SectionCard
                    ...
                    colorClass="bg-[#fafbff] text-[#6366f1]"
                  >
                    <Field
                      label="Experience (Years)"
                      value={String(driver.driving_experience || 0)}
                    />
                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex items-center justify-between py-2 border-b border-[#f1f5f9]">
                        <span className="text-[11px] font-[900] text-[#64748b] uppercase tracking-wide">
                          Safety Induction
                        </span>
                        <span
                          className={`px-2 py-0.5 rounded text-[10px] font-black uppercase ${driver.safety_training_completion === "YES" ? "bg-[#ecfdf5] text-[#059669]" : "bg-[#f8fafc] text-[#94a3b8]"}`}
                        >
                          {driver.safety_training_completion === "YES" ? "CERTIFIED" : "PENDING"}
                        </span>
                      </div>
                      <div className="flex items-center justify-between py-2 border-b border-[#f1f5f9]">
                        <span className="text-[11px] font-[900] text-[#64748b] uppercase tracking-wide">
                        ...
                        <span
                          className={`px-2 py-0.5 rounded text-[10px] font-black uppercase ${driver.medical_fitness === "YES" ? "bg-[#ecfdf5] text-[#059669]" : "bg-[#f8fafc] text-[#94a3b8]"}`}
                        >
                          {driver.medical_fitness === "YES" ? "FIT" : "EXPIRED"}
                        </span>
                      </div>
                      <div className="flex items-center justify-between py-2">
                        ...
                        <span
                          className={`px-2 py-0.5 rounded text-[10px] font-black uppercase ${driver.police_verification === "YES" ? "bg-[#ecfdf5] text-[#059669]" : "bg-[#f8fafc] text-[#94a3b8]"}`}
                        >
                          {driver.police_verification === "YES" ? "VERIFIED" : "PENDING"}
                        </span>
                      </div>
                    </div>
                  </SectionCard>
                  ...
                  {driver.license_insurance && driver.license_insurance.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                      {driver.license_insurance.map((li, i) => (
                        <div
                          key={i}
                          className="p-4 rounded-[14px] bg-[#f8faff] border border-[#e2e8f0] flex items-center justify-between hover:border-[#7c3aed] transition-colors group"
                        >
                          <div>
                            <p className="text-[10px] font-black text-[#7c3aed] uppercase mb-1">
                              {li.type || "PERMIT"}
                            </p>
                            <p className="text-[13px] font-[900] text-[#1e293b]">{li.number}</p>
                          </div>
                          <div className="text-right">
                            <p className="text-[9px] font-[800] text-[#94a3b8] uppercase">
                              Expires
                            </p>
                            <p className="text-[11px] font-[900] text-[#475569]">
                              {formatDate(li.exp_date)}
                            </p>
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="py-8 text-center bg-[#fafbff] rounded-[16px] border border-dashed border-[#e2e8f0]">
                      <p className="text-[11px] font-[900] text-[#94a3b8] uppercase tracking-widest">
                        No active permits in registry
                      </p>
                    </div>
                  )}
                </SectionCard>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  {driver.aadhaar_card && (
                    <DocumentItem
                      ...
                      path={driver.aadhaar_card}
                      updatedAt={driver.updated_at}
                    />
                  )}
                  {driver.pan_card && (
                    <DocumentItem
                      label="Tax Registry (PAN)"
                      path={driver.pan_card}
                      updatedAt={driver.updated_at}
                    />
                  )}
                ...
                {driver.beacon_id ? (
                  <div className="max-w-md mx-auto p-6 bg-white rounded-2xl border border-[#e2e8f0] shadow-sm flex flex-col items-center text-center">
                    ...
                    <p className="text-[12px] text-[#64748b] mb-6">
                      This driver is currently assigned to a physical tracking device.
                    </p>
                  ...
                  <div className="py-16 text-center max-w-sm mx-auto">
                    ...
                    <p className="text-[12.5px] text-[#94a3b8] mb-6">
                      This driver does not have any physical beacon linked to them yet.
                    </p>
                    <button
                      onClick={() => navigate(`/drivers/edit/${id}`)}
