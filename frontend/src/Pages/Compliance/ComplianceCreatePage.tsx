        ...
        <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  <label className="form-label">
                    Document / Rule Name
                    <span style={{ color: "rgb(220, 38, 38)", marginLeft: "2px" }}>*</span>
                  </label>
                  <input
                ...
                <div>
                  <label className="form-label">
                    Category<span style={{ color: "rgb(220, 38, 38)", marginLeft: "2px" }}>*</span>
                  </label>
            ...
            <div style={{ padding: "24px" }}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <select
                    {...register("authority_name", { required: true })}
          ...
          <div className="form-card">
            ...
            <div style={{ padding: "24px" }}>
              ...
              <div>
                <label className="form-label">
                  Applies To<span style={{ color: "rgb(220, 38, 38)", marginLeft: "2px" }}>*</span>
                </label>
                <div className="flex flex-wrap gap-3 mt-2">
                  {applicabilityOptions.map((option) => (
                    <label
                      ...
                      style={{
                        ...
                        borderRadius: "8px",
                        border: "1.5px solid var(--border)",
                        background: selectedAppliesTo.includes(option)
                          ? "var(--primary-light)"
                          : "var(--surface)",
                        borderColor: selectedAppliesTo.includes(option)
                          ? "var(--primary)"
                          : "var(--border)",
                        transition: "0.15s",
                      }}
                    >
                      ...
                      <span
                        style={{
                          fontSize: "13px",
                          fontWeight: 700,
                          color: selectedAppliesTo.includes(option)
                            ? "var(--primary)"
                            : "rgb(71, 85, 105)",
                        }}
                      >
          ...
          <div className="form-card">
            ...
            <div style={{ padding: "24px" }}>
              <label className="form-label flex items-center gap-1">
                Compliance Document{" "}
                <span style={{ color: "rgb(220, 38, 38)", marginLeft: "2px" }}>*</span>{" "}
                <InfoTooltip message="Max 10MB. PDF, JPG, PNG" />
              </label>
              <label
                style={{
                  display: "flex",
              ...
              >
                <span
                  className="material-symbols-outlined"
                  style={{ fontSize: "36px", color: "rgb(148, 163, 184)" }}
                >
                  cloud_upload
                </span>
                <span style={{ fontSize: "14px", fontWeight: 700, color: "rgb(100, 116, 139)" }}>
                  Click to Upload Document
                </span>
                <span style={{ fontSize: "11px", color: "rgb(148, 163, 184)" }}>
            ...
            <div style={{ padding: "24px" }}>
              ...
              >
                ...
                >
                  <input
                    type="checkbox"
                    {...register("consent_certified", { required: true })}
                    style={{
                  ...
                  <div>
                    <span style={{ fontSize: "14px", fontWeight: 800, color: "var(--text)" }}>
                      Compliance Certification <span style={{ color: "rgb(220, 38, 38)" }}>*</span>
                    </span>
                    <div
                      style={{
                        fontSize: "13px",
                    ...
                    >
                      "I confirm that all submitted compliance information is accurate, valid, and
                      up-to-date as per the applicable laws and regulations."
                    </div>
                  </div>
                </label>
              </div>
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3 pb-8">
            <button
              ...
              className="btn btn-secondary order-2 sm:order-1 sm:mr-auto w-full sm:w-auto justify-center"
            >
              Cancel
            </button>
            <button
              ...
              className="btn btn-primary order-1 sm:order-2 w-full sm:w-auto justify-center"
            >
